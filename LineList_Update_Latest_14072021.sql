...
DROP TABLE IF EXISTS CIHP_VL_SampleCol;
CREATE TEMPORARY TABLE CIHP_VL_SampleCol AS
SELECT * FROM (SELECT @row_no := IF(@prev_val = o.person_id , @row_no + 1, 1) AS Occurrence, @prev_val := o.person_id AS person_id,
...
ORDER BY o.person_id, o.`obs_datetime` DESC)a WHERE a.Occurrence = 1;
/*Update End 14th July 2021*/
