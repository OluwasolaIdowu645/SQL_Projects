...
c.NextAppmt, @DATIMCode DATIMCode, ROUND((TO_DAYS(@Reporting_Date) - TO_DAYS(C.ARTStartDate)) / ((SELECT DAYOFYEAR(CONCAT(YEAR(@Reporting_Date),'-12-31')))/12)) AS MonthOnART,
